...
from Metrics_and_Visualizations import plot_confusion_matrix, plot_training_history, show_error_samples, \
    plot_class_distribution, plot_feature_importance, plot_weight_recognition
...
layer_dims = [784, 56, 28, 10]
activations = ["relu", "relu", "relu", "sigmoid"]
#param_scale=0.01, learning_rate=0.00075, batch_size=32, num_iterations=1000,

# Run the Model and Make Predictions
parameters, costs = dnn.L_layer_model(X_train, y_train, layer_dims, activations, param_scale=0.01, learning_rate=0.00074, batch_size=32, num_iterations=250, use_softmax=True, momentum_factor=0.6, loss_function="cross_entropy_loss", print_cost=True)
...
plot_weight_recognition(parameters["W1"])
